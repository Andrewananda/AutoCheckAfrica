...
struct CarDetailResponse: Codable {
    let features, carFeatures, modelFeatures, damageMedia: [JSONAny]
    let id: String
    let year: Int
    let insured: Bool
    let mileage: Int
    ...
    let carName, ccMeasurement: String?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case sold, hasThreeDImage, inspectorDetails, carName, ccMeasurement
    }
}
